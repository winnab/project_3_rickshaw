class Stop < ActiveRecord::Base
	attr_accessible :id, :driver_id, :scheduled_datetime, :stop_contact_name, :job_status, :client_name, :stop_type, :rickshaw_foreign_id, :stop_address, :latitude, :longitude
